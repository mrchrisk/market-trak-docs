...
<Callout kind="tip">
Want the big picture? The **Analytics** page (under **Measure** in the sidebar) has a **Lead Sources** tab that totals all your leads by channel, traffic source, and campaign, so you can see at a glance which marketing is working. This page is about the channel label on each individual lead.
</Callout>
