...
<Callout kind="tip">
Want the big picture? The **Analytics** page (under **Measure** in the sidebar) totals your leads by channel and campaign in its **Every channel** and **Top campaigns** cards, for the 7, 30 or 90 days you pick, so you can see at a glance which marketing is working. This page is about the channel label on each individual lead.
</Callout>
...
<Image src="https://db.marketrak.pro/storage/v1/object/public/broadcast-assets/docs/docs-lead-sources.png" width="1920" height="1080" alt="A lead record showing the Where this lead came from section with channel and captured via, plus areas of interest and activity (contact details blurred)" />

<Callout kind="info">
The **Source** column on the main Leads table shows how the lead entered Market Trak (report, valuation, import). Enquiries from a lead-ad form name the network the form was filled on, so an Instagram enquiry reads "Instagram ad", not "Facebook ad". The channel is the marketing origin, and it lives on the lead record.
</Callout>
...
|------------------------|----------------------------------|
| Facebook ad | `?utm_source=facebook&utm_medium=paid` |
| Instagram ad | `?utm_source=instagram&utm_medium=paid` |
...
```text
https://mtrak.me/valuation/your-agency?utm_source=facebook&utm_medium=paid&utm_campaign=spring-valuations
```
...
<Callout kind="info">
Tag Instagram links with `utm_source=instagram`, not `utm_source=facebook`. The label follows the tag, so an Instagram ad tagged as Facebook reads "Facebook ad" on every lead it brings in. Property ads you launch from Market Trak tag themselves correctly, so this only applies to links you share yourself.
</Callout>
...
(function () {
  ...
  var TRACK = ['utm_source','utm_medium','utm_campaign','utm_term','utm_content','gclid','fbclid','msclkid','igsh','igshid','ttclid'];
