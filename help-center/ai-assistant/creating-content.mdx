...
- **Statement** - a large line of type on a block of your brand colour.
...
You can change your look whenever you like from the **Branding** tab in **Workspace Settings**: the **Image Look** card shows the same three samples, and you tap to switch. New images follow your new look; images you have already made stay as they are.

<Callout kind="tip">
An image is only made when you ask for one, because generating an image uses credits. Say "with an image" and you get a picture; just ask for a post and you get the words on their own. Changed your mind? Say **add an image** and the same post comes back with one, wording untouched.
</Callout>
