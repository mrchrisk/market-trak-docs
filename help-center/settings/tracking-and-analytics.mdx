...
<Image src="https://db.marketrak.pro/storage/v1/object/public/broadcast-assets/docs/docs-tracking-analytics.png" width="1920" height="1080" alt="The Tracking and Analytics section with fields for the Facebook Pixel, GA4, Google Tag Manager and Google Ads IDs (values blurred)" />
...
Add a link to your agency's privacy policy here. The same URL is used in two places:

- On the **cookie consent banner** that appears on your public reports
- On the **lead capture forms** (report unlock, instant valuation, embed signup, email signup) so visitors can read your policy before submitting their details

If you leave this empty, a generic consent message is shown on the cookie banner and the privacy line is hidden on lead forms. Setting it once here covers everything; you no longer need to set it anywhere else.
...
## Every lead reaches your Facebook Pixel

If you run Facebook or Instagram ads, the leads your Pixel reports are what Facebook learns from. It uses them to decide who sees your ads next, and to work out what each lead costs you in Ads Manager. The more of your real leads it knows about, the better it can find people like them, and the truer your numbers are.

The trouble is that the Pixel runs in your visitor's browser, so it misses some leads: people on iPhones, people with ad blockers, people browsing inside the Facebook app, and anyone who declines cookies. Those leads still reach you in Market Trak, but your Facebook ads never get the credit for them.

So Market Trak also sends each lead to your Facebook Pixel from our side. That gives you:

- **A truer cost per lead.** Facebook hears about the leads the browser missed, so Ads Manager can credit more of them to the ads that brought them in.
- **Ads that learn from more of your leads.** Facebook has more real enquiries to learn from when it chooses who to show your ads to.
- **No double counting.** Facebook counts each lead once, even when both the browser and Market Trak report it.

This covers instant valuations on your valuation page, report unlocks and your signup forms. There's nothing to install.

To turn it on:

<Steps>
<Step title="Add your Facebook Pixel ID" icon="settings" titleType="p">
Enter it in the **Tracking & Analytics** section, as described above.
</Step>
<Step title="Allow advertising" icon="megaphone" titleType="p">
Go to **Workspace Settings**, open **Integrations**, and tap **Allow advertising** on the Advertising card. If the card already shows your ad account, there is nothing to do.
</Step>
</Steps>

Your lead forms show a short line telling visitors you may share their details with advertising and analytics partners, such as Meta and Google.

<Callout kind="info">
If you use the instant valuation form embedded on your own website, that form still reports leads from your website's own pixel only.
</Callout>

### Facebook shows fewer leads than Market Trak

- **Check Traffic permissions.** In Meta Events Manager, open your Pixel's **Settings** and look at **Traffic permissions**. If you only allow certain websites, add **mtrak.me**, which is where your valuation page and reports are hosted. Otherwise Facebook ignores what your Pixel sees there.
- **Check you have allowed advertising** under **Workspace Settings > Integrations**. If your Facebook connection has expired, reconnect it there.
- **Give it a day.** Ads Manager can take a few hours to show new leads, and counts them against the day of the ad click.
