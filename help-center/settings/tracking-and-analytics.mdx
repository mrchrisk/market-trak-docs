...
<Callout kind="alert">
You must add **marketrak.pro** to your pixel's allowed domains, or the pixel will be blocked. In Events Manager, click your Pixel, go to **Settings**, scroll to **Allowed Domains**, and add `marketrak.pro`. Without this, Facebook will reject tracking events from your Market Trak reports and valuation pages.
</Callout>
