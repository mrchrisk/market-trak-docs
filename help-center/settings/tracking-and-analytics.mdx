...
description: Add Facebook Pixel, Google Analytics, and Google Tag Manager to your public reports for retargeting and visitor insights.
---
...
You only need to add the ones you use. Most agents start with Facebook Pixel and Google Analytics.
...
- **Measure conversions** from report views to valuation requests
